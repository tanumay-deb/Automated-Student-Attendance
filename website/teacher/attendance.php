...
try {
  ...
  if (isset($_POST['att'])) {
    ...
    foreach ($_POST['st_status'] as $i => $st_status) {
      ...
      $stat_id = $_POST['st_name'][$i];
      $dp = date('d/m/Y');
      $tt = date("h:i:s");
      // $course = $_POST['whichcourse'];

      $stat = mysqli_query($con, "insert into attendance(Name,Status,Time,Date) values('$stat_id','$st_status','$tt','$dp')");
    ...
    <div class="row">
      ...
      <div class="content">
        ...
        <form action="" method="post">
              ...
              while ($data = mysqli_fetch_array($all_query)) {
                ...
                <body>
                  <tr>
                    ...
                    <td>
                      <?php echo $data['st_name']; ?> <input type="hidden" name="st_name[]"
          ...
          <center><br>
            <input  type="submit" id="sav11" class="btn btn-primary col-md-2 col-md-offset-10" value="Save!" name="att"  />
          </center>
